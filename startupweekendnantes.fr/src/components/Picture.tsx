...
/**
 * <img> with auto avif/webp <source>s and intrinsic width/height pulled from the
 * generated manifest (src/data/image-manifest.ts → run scripts/optimize-images.mjs),
 * which prevents layout shift (CLS). The <picture> uses `display: contents` so it
 * adds no box — existing CSS that targets the inner <img> keeps working unchanged.
 *
