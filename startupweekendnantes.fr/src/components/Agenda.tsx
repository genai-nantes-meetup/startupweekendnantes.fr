...
const days: Day[] = [
  {
    ...
    rows: [
      ...
      { time: '21h15', title: 'KEA sur le pitch et les startups', desc: 'Par Claire Bretton de Underdog', speaker: { name: 'Claire Bretton', img: 'https://framerusercontent.com/images/8JSXibl4A4aZTwJgXOWiMm5Yio.jpeg' } },
  ...
  },
  {
    ...
    rows: [
      ...
      { time: '9h', title: 'Lancement de la journée', desc: 'Agenda et grandes étapes de la journée.', speakers: ['https://framerusercontent.com/images/hnQXqgk32dqlRBwcUizHzN1Q.jpeg', 'https://framerusercontent.com/images/ZxVXYgfcXSA9Icu75YPXMpFKm2Y.png'] },
      { time: '9h15', title: 'Conférences : Marché + IA Générative', desc: 'Par Pauline Corriou et Simon Timssale', speakers: ['https://framerusercontent.com/images/VQm4I4LuWNHC0UemB1sslF3p8.jpeg', 'https://framerusercontent.com/images/lyIwOv1puBWIqCuDn2zoYOXI9BY.jpeg'] },
